...
class TableTest {
    ...
    private void removeSomeTokensAndAssert() throws InterruptedException {
        assertEquals(true, table.getToken()[0].contains(0));
    ...
    void removeCard_AllSlotAreFilled() throws InterruptedException {

        fillAllSlots();
        removeSomeCardsAndAssert();
    }
    @Test
    void removeCard_SomeSlotAreFilled() throws InterruptedException {
